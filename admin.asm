...
.data
    ...
    mainmsg3 db 10,13,'2. Search Accounts by City$'
    mainmsg4 db 10,13,'3. Search Accounts by State$'
    mainmsg5 db 10,13,'4. Total number of users$'
...
;macro blank_string str
;    mov si, offset str
;    mov di, offset blank_var
;    mov cx,20
;    copy_loop:
;    movsb
;    loop copy_loop
